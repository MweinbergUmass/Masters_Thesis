...
distance_features = CalculateDistanceFeatures(proc_mice_pos_data.processedData,feature_table_dist);


feature_list_fn_ang = project.parameters.features.angles_xlsx_path;
feature_table_ang = readtable(feature_list_fn_ang);
angle_features = CalculateAngleFeatures(proc_mice_pos_data.processedData,feature_table_ang);
