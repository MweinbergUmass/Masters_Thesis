function segment(proc_mice_pos_data_path,segmentation_data, project)
    ...
    project.updateProcessingStatus(proc_mice_pos_data_path, 'segmentation', true, proc_mice_pos_data);
    project.saveProject();
end
